...
In [LangRecognizer](https://github.com/hayj/NLPTools/blob/master/nlptools/langrecognizer.py) (comming soon TODO) we use a SD to do not re-compute text we already for which we already recognized the lang. It allow the user of this library to do not take care of the computation time of the NLP function in the case he already ask the lang of a text.
